...
<html lang="en">
  ...
  <body>
    ...
    <form action= "<?=base_url('users/update_images')?>" method="post">
<input type="hidden" name="id" value="<?=$row['id']?>">
  <div class="mb-3">
    <label for="id_user" class="form-label">ID_USER</label>
    <input type="text"  value="<?=$row['id_user']?>" class="form-control" name= "id_user" id="id_user" aria-describedby="emailHelp">
