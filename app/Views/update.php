  ...
  <div class="container">
    <form action="<?=base_url('users/update')?>" method="post" enctype="multipart/form-data">
      ...
      <div class="mb-3">
        ...
        <input type="text" value="<?=$row['email']?>" class="form-control" name="email" id="email"
          aria-describedby="emailHelp">
        <div id="emailHelp" class="form-text">We'll never share your email with anyone else.</div>
      </div>
      <div class="mb-3">
        <label for="status" class="form-label">status </label>
        <input type="text" value="<?=$row['status']?>" class="form-control" name="status" id="status"
          aria-describedby="emailHelp">
      ...
      <div class="mb-3">
        ...
        <input type="text" value="<?=$row['password']?>" class="form-control" name="password" id="password"
          aria-describedby="emailHelp">
